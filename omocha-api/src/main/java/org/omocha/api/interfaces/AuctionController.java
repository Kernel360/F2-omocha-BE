...
import org.omocha.client.auction.application.AuctionService;
import org.omocha.api.interfaces.request.CreateAuctionRequest;
import org.omocha.api.interfaces.response.AuctionDetailResponse;
import org.omocha.api.interfaces.response.AuctionListResponse;
import org.omocha.api.interfaces.response.CreateAuctionResponse;
import org.omocha.client.common.dto.ResultDto;
import org.omocha.client.jwt.UserPrincipal;
...
public class AuctionController implements AuctionApi {
	...
	public ResponseEntity<ResultDto<CreateAuctionResponse>> auctionSave(
		...
		ResultDto<CreateAuctionResponse> resultDto = ResultDto.res(
			AuctionCode.AUCTION_CREATE_SUCCESS.getStatusCode(),
			AuctionCode.AUCTION_CREATE_SUCCESS.getResultMsg(),
			response
		);
	...
	public ResponseEntity<ResultDto<Page<AuctionListResponse>>> auctionList(
		...
		ResultDto<Page<AuctionListResponse>> resultDto = ResultDto.res(
			AuctionCode.AUCTION_LIST_ACCESS_SUCCESS.getStatusCode(),
			AuctionCode.AUCTION_LIST_ACCESS_SUCCESS.getResultMsg(),
			response
		);

		return ResponseEntity
			.status(AuctionCode.AUCTION_LIST_ACCESS_SUCCESS.getHttpStatus())
			.body(resultDto);
	}
	...
	public ResponseEntity<ResultDto<AuctionDetailResponse>> auctionDetails(
		...
		ResultDto<AuctionDetailResponse> resultDto = ResultDto.res(
			AuctionCode.AUCTION_DETAIL_SUCCESS.getStatusCode(),
			AuctionCode.AUCTION_DETAIL_SUCCESS.getResultMsg(),
			response
		);

		return ResponseEntity
			.status(AuctionCode.AUCTION_DETAIL_SUCCESS.getHttpStatus())
			.body(resultDto);
	}
	...
	public ResponseEntity<ResultDto<Void>> auctionRemove(
		...
		ResultDto<Void> resultDto = ResultDto.res(
			AuctionCode.AUCTION_DELETE_SUCCESS.getStatusCode(),
			AuctionCode.AUCTION_DELETE_SUCCESS.getResultMsg(),
			null
		);

		return ResponseEntity
			.status(AuctionCode.AUCTION_DELETE_SUCCESS.getHttpStatus())
			.body(resultDto);
	}
